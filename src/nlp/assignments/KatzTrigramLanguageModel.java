...
class KatzTrigramLanguageModel implements LanguageModel {
	...
	//static final double lambda1 = 0.4;
	//static final double lambda2 = 0.4;
	...
	public double getTrigramProbability(String prePreviousWord,
			String previousWord, String word,double lambda1,double lambda2) {
	...
	public double getSentenceProbability(List<String> sentence,double l1,double l2) {
